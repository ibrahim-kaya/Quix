        ...
        @foreach($quiz->sorular as $soru)
            <div class="flex items-center pb-3">
                <h1 class="text-lg font-bold"><button
                        ...
                        wire:click="openEditModal({{ $soru->id }})"><i class="fas fa-edit"></i>
            ...
            @if($soru->cevap3) <p class="secenek-box @if($soru->dogru_cevap == 'cevap3') dogru @endif">c) {{ $soru->cevap3 }}</p> @endif
            @if($soru->cevap4) <p class="secenek-box @if($soru->dogru_cevap == 'cevap4') dogru @endif">d) {{ $soru->cevap4 }}</p> @endif
            <br>
                ...
                <div id="edit_modal_icerik" class="modal_icerik">
                    <div class="px-5 py-3 max-h-96 md:max-h-full overflow-y-scroll md:overflow-hidden">
                        <div class="flex flex-col">
                            <form id="soru_guncelle" method="post" action="{{ route('soru_guncelle', [$quiz->uniqueid, $qid]) }}" class="flex flex-col" enctype="multipart/form-data">
                                @csrf
        ...
        $('#yeni').click(function () {
            ...
            <label><b>Soruyu yaz:</b></label><br>
             <textarea class="rounded-md mb-4" name="soru"> {{ old('soru') }}</textarea><br>
                            ...
                            <div class="w-full lg:w-1/2">
                            <label><b>C şıkkı:</b></label><br>
                              <input type="text" name="cevap3" class="rounded-md w-full p-1" value="{{ old('cevap3') }}" placeholder="Boş bırakılabilir...">
                            ...
                            <label><b>D şıkkı:</b></label><br>
                               <input type="text" name="cevap4" class="rounded-md w-full p-1" value="{{ old('cevap4') }}" placeholder="Boş bırakılabilir...">
