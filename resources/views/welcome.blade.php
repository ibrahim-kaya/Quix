...
<nav>
    ...
    >
        ...
        <div>
            <a href="{{ route('login') }}"><button class="btn--primary">Giriş Yap</button></a>
            <a href="{{ route('register') }}"><button class="btn--orange">Kayıt Ol</button></a>
        </div>
    </div>
</nav>
<!--Hero-->
...
>
    <div class="container mx-auto px-6">
        ...
        <a href="{{ route('quizler.index') }}"><button
