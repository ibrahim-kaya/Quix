            ...
            var html = `
                          <div class="px-5 py-3 max-h-96 md:max-h-full overflow-y-scroll md:overflow-hidden">
                            ...
                            <label><b>C şıkkı:</b></label><br>
                              <input type="text" name="cevap3" class="rounded-md w-full p-1" value="<?php echo e(old('cevap3')); ?>">
                            ...
                            <label><b>D şıkkı:</b></label><br>
                               <input type="text" name="cevap4" class="rounded-md w-full p-1" value="<?php echo e(old('cevap4')); ?>">
