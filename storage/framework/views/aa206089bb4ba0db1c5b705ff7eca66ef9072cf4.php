...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> ~ İstediğin sorudan başla!</title>
...
<section class="container mx-auto px-6 p-10">
    ...
    <div class="flex items-center flex-wrap mb-20">
        <div class="w-full md:w-1/2">
            ...
            <p class="text-gray-600 mb-8">
                Önceden hazırlanıp koyulmuş Quizler sıkıcı mı geliyor? O zaman oyuna seni de dahil edelim! <?php echo e(config('app.name')); ?>'de kendi
    ...
    <div class="flex items-center flex-wrap mb-20">
        <div class="w-full md:w-1/2">
            ...
            <p class="text-gray-600 mb-8">
                Sadece yazılarla hazırlanmış Quizler sıkıcı mı geliyor? Bizce de öyle. O yüzden <?php echo e(config('app.name')); ?>'de istersen
