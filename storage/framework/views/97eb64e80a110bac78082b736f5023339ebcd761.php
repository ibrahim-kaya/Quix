            ...
            <table class="min-w-full leading-normal quiz-table mb-5 border-t border-gray-200">
                ...
                <?php $__currentLoopData = $data['quizzes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 text-sm">
                            <a href="<?php echo e(route('quizler.show', $quiz->uniqueid)); ?>" class="<?php echo e(($quiz->durum ? 'hidden' : '')); ?>" title="Görüntüle"><button class="btn btn--orange"><i class="fa fa-file-alt"></i></button></a>
                            <a href="<?php echo e(route('quizler.edit', $quiz->uniqueid)); ?>" class="<?php echo e(($quiz->durum ? 'hidden' : '')); ?>" title="Düzenle"><button class="btn btn--primary"><i class="fa fa-edit"></i></button></a>
                            <button wire:click="quizSil('<?php echo e($quiz->uniqueid); ?>')" class="btn btn--red" title="Sil"><i class="fas fa-trash-alt"></i></button>
                        </td>
                    </tr>
